...
XStatus Poe_Initialize(void) {
   ...
   I2C_ByteWrite(IIC_POE0_ADDR, REG_PORT_REMAP, 0xE4);
   I2C_ByteWrite(IIC_POE1_ADDR, REG_PORT_REMAP, 0xE4);

   I2C_ByteWrite(IIC_POE0_ADDR, REG_PORT_MODE, 0x00);
   I2C_ByteWrite(IIC_POE1_ADDR, REG_PORT_MODE, 0x00);
